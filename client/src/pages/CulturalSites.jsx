...
const Culture = () => {
  ...
  "
            ...
            <p className="text-xl max-w-4xl mx-auto leading-relaxed text-gray-100">
              Discover the rich tapestry of tribal traditions, ancient
              festivals, and living heritage that makes Jharkhand a unique
              cultural destination in India.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Meet the diverse tribal communities that call Jharkhand home, each
              with their unique customs and contributions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {tribalCommunities.map((tribe, index) => (
              <Card
                key={index}
                className="p-6 border shadow-md hover:shadow-lg transition-all duration-200"
              >
                <div className="text-center">
                  ...
                  <Badge className="mb-3 bg-gray-200 text-gray-700">
                    {tribe.population}
                  </Badge>
      ...
      <section className="py-20 bg-gradient-to-r from-green-700 via-green-500 to-yellow-400 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto text-gray-100">
            Join us for an authentic cultural journey that connects you with the
            heart and soul of tribal Jharkhand.
          </p>
          <div className="group-hover flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-gradient-to-r from-green-600 to-yellow-400 text-white border-0 hover:shadow-lg"
            >
              Plan Cultural Tour
            </Button>
            <Button
              size="lg"
              variant="outline"
              className="border-white text-black group-hover:bg-amber-700 hover:text-green-700"
            >
