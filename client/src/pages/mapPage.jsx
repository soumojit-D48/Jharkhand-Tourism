...
const MapPage = () => {
  ...
  const calculateRoute = async () => {
    ...
    try {
      ...
      if(!toResult) {
        setError('Could not find "Destination" location! Please check the spelling.')
        setIsCalculating(false)
        return
      }
      ...
      if(map) { // createRouteOnMap from utils
        const newRouteLayer = createRouteOnMap(map, routeData, fromResult, toResult)
  ...
  const clearRoute = () => { // clearRouteFromMap is from utils
