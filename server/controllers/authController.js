...
const register = async (req, res) => {
    ...
    try {
        ...
        //      <p>Welcome to our platform. Your email is successfully registered.</p>
        //      <p>Regards,<br>Team</p>`
        // })
...
const sendVerifyOtp = async (req, res) => {
    try {
        ...
        user.verifiyOtp = otp
        user.verifyOtpExpireAt = Date.now() + 1 * 60 * 60 * 1000 // 1hr
...
const varifyedEmail = async (req, res) => {
    ...
    try {
        ...
        if(user.verifiyOtp === '' || user.verifiyOtp !== otp){
